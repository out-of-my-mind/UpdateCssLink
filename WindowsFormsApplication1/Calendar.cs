...
namespace WindowsFormsApplication1
{
    class Calendar
    {
        ...
        /// 中国日历异常处理
        /// 用公历（阳历）初始化
        /// Calendar cc = new Calendar(Convert.ToDateTime("2010/4/5"));
        /// Calendar cc = new Calendar(DateTime.Today);
        /// 用农历（阴历）初始化，润五月（润月用True否则用False)，公历2009年7月8日
        /// Calendar cc = new Calendar(2009, 5, 16, true);
        ...
        private static SolarHolidayStruct[] sHolidayInfo = new SolarHolidayStruct[]{
            ...
            new SolarHolidayStruct(4, 1, 0, "清明节"),
        ...
        #region 节日
        #region CalendarHoliday
        /// <summary>
        /// 计算中国农历放假节日   春节、端午、中秋
        /// </summary>
        public string CalendarHoliday
        {
            get
            {
                string tempStr = "";
